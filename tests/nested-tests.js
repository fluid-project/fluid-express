...
fluid.registerNamespace("gpii.express.tests.nested");
fluid.defaults("gpii.express.tests.nested", {
...
var nested = gpii.express.tests.nested({});

jqUnit.module("Testing nested express module stack...");
...
jqUnit.asyncTest("Testing the 'static' router module (custom content)...", function() {
    var options = {
        url: nested.express.options.config.express.baseUrl + "custom.html"
    };
    request.get(options, function(error, response, body) {
        jqUnit.start();
...
jqUnit.asyncTest("Testing the 'hello' router module...", function() {
    var options = {
        url: nested.express.options.config.express.baseUrl + "hello"
    };
    request.get(options, function(error, response, body) {
        jqUnit.start();
        ...
        jqUnit.assertEquals("The body should match the configured content...", nested.express.hello.options.message, body);
    });
});

jqUnit.asyncTest("Testing module nesting with the 'hello/world' router module...", function() {
    var options = {
        url: nested.express.options.config.express.baseUrl + "hello/world"
    };
    request.get(options, function(error, response, body) {
        jqUnit.start();
        ...
        jqUnit.assertEquals("The nested body should match the configured content...", nested.express.hello.world.options.message, body);
    });
});

jqUnit.asyncTest("Testing middleware isolation with '/hello/rv'.", function() {
    var options = {
        url: nested.express.options.config.express.baseUrl + "hello/rv"
    };
    request.get(options, function(error, response, body) {
        jqUnit.start();
...
jqUnit.asyncTest("Testing a wildcard path (root)...", function() {
    var options = {
        url: nested.express.options.config.express.baseUrl + "wildcard/"
    };
    request.get(options, function(error, response, body) {
        jqUnit.start();
        ...
        jqUnit.assertEquals("The nested body should match the configured content...", nested.express.wildcard.options.message, body);
    });
});

jqUnit.asyncTest("Testing a wildcard path (deep)...", function() {
    var options = {
        url: nested.express.options.config.express.baseUrl + "wildcard/more/path/information"
    };
    request.get(options, function(error, response, body) {
        jqUnit.start();
...
jqUnit.asyncTest("Testing the 'count' middleware to ensure it collects data...", function() {
    var originalValue = nested.express.middleware.model.count;
    var options = {
        url: nested.express.options.config.express.baseUrl
    };
    request.get(options, function(error, response, body) {
        ...
        var newValue = nested.express.middleware.model.count;
...
jqUnit.asyncTest("Test the 'body parser' middleware (json)...", function(){
    var options = {
        url:  nested.express.options.config.express.baseUrl + "reqview",
        json: { "foo": "bar" }
    };
