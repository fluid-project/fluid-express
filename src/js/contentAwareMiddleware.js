...
fluid.registerNamespace("fluid.express.middleware.contentAware");
 ...
 *
 */
fluid.express.middleware.contentAware.delegateToHandler = function (that, request, response, next) {
    var handlerGrades = fluid.express.middleware.contentAware.getHandlerGradesByContentType(that, request);
    if (handlerGrades) {
 ...
 *
 */
fluid.express.middleware.contentAware.getHandlerGradesByContentType = function (that, request) {
...
fluid.defaults("fluid.express.middleware.contentAware", {
    ...
    invokers: {
        middleware: {
            funcName: "fluid.express.middleware.contentAware.delegateToHandler",
